...
class Trackball:
    ...
    def zoom(self, delta, size):
        ...
        self.distance = max(Trackball.MIN_DIST, self.distance * (1 - 50 * delta / size))
    ...
    def move_to(self, new):
        self.rotation = vec(1, 0, 0, 0)
        self.pos2d = vec(new)

    def move_z(self, delta):
        self.distance = max(Trackball.MIN_DIST, self.distance + delta)

    def rotate_front(self):
        self.rotation = vec(0.8, -0.6, -0.28, 0.24)
